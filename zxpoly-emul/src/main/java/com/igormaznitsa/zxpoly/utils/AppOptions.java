...
public final class AppOptions {
    ...
    public enum Rom {
        ...
        ZX128WOS("ROM ZX-128 TRDOS (WoS)", "http://wos.meulie.net/pub/sinclair/emulators/pc/russian/ukv12f5.zip"),
        ZX128ARCH("ROM ZX-128 TRDOS (Archive.org)", "https://archive.org/download/World_of_Spectrum_June_2017_Mirror/World%20of%20Spectrum%20June%202017%20Mirror.zip/World%20of%20Spectrum%20June%202017%20Mirror/sinclair/emulators/pc/russian/ukv12f5.zip"),
        ZX128PDP11RU("ROM ZX-128 TRDOS (Pdp-11.ru)", "http://mirrors.pdp-11.ru/_zx/vtrdos.ru/emulz/UKV12F5.ZIP"),
    ...
    public synchronized String getAddress() {
        return preferences.get(Option.STREAM_ADDR.name(), InetAddress.getLoopbackAddress().getHostAddress());
    }
