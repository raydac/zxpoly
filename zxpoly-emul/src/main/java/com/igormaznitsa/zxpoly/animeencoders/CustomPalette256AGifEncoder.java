...
public final class CustomPalette256AGifEncoder implements AnimationEncoder {
  ...
  public CustomPalette256AGifEncoder(final File file, final int[] rgbPalette, final int frameRate, final boolean loop) throws IOException {
