...
public final class Spec256AGifEncoder implements AnimationEncoder {
  ...
  private static void compress(final OutputStream stream, final int codeSize, final byte[] data, final byte[] dataBuffer256) throws IOException {
    ...
    final Spec256AGifEncoder.BitBuffer256 bitFile = new Spec256AGifEncoder.BitBuffer256(stream, dataBuffer256);
    final Spec256AGifEncoder.LzwTable strings = new Spec256AGifEncoder.LzwTable();
