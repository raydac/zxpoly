...
public class Z80Test extends AbstractZ80Test {
  ...
  public void testCommand_LD_A_I_NonZeroAndNegativeIFF2True() {
    ...
    assertEquals(Z80.FLAG_C | Z80.FLAG_S | Z80.FLAG_PV, cpu.getRegister(Z80.REG_F));
    assertTacts(cpu, 9);
  }
  ...
  public void testCommand_LDI_BCPostive() {
    ...
    assertEquals(Z80.FLAG_S | Z80.FLAG_Z | Z80.FLAG_C | Z80.FLAG_PV, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommand_LDI_BCZero() {
    ...
    assertEquals(Z80.FLAG_S | Z80.FLAG_Z | Z80.FLAG_C, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommand_CPI_NotEqual() {
    ...
    assertEquals(0x1112, cpu.getRegisterPair(Z80.REGPAIR_HL));
    assertEquals(0x0000, cpu.getRegisterPair(Z80.REGPAIR_BC));
    assertEquals(Z80.FLAG_C | Z80.FLAG_N, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommand_CPI_BCNotZeroAndNoEqual() {
    ...
    assertEquals(Z80.FLAG_C | Z80.FLAG_PV | Z80.FLAG_N, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommand_CPIR_EqualsNotPresented() {
    ...
    assertEquals(0x0000, cpu.getRegisterPair(Z80.REGPAIR_BC));
    assertEquals(Z80.FLAG_C | Z80.FLAG_N | Z80.FLAG_H, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommand_ADD_C_notFlagSet() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_ADD_C_flagV() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_PV | Z80.FLAG_S | Z80.FLAG_H, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_ADD_C_flagsZCH() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_Z | Z80.FLAG_C | Z80.FLAG_H, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_ADC_C_flagsCH() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_C | Z80.FLAG_H, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_SUB_C() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_N | Z80.FLAG_PV, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_AND_C() {
    ...
    assertEquals(0x11, cpu.getRegister(Z80.REG_C));
    assertEquals(0x01, cpu.getRegister(Z80.REG_A));
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_H, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_AND_C_ZeroResult() {
    ...
    assertEquals(0x00, cpu.getRegister(Z80.REG_A));
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_Z | Z80.FLAG_H | Z80.FLAG_PV, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_OR_C() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_PV, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_CP_C_Equals() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_Z | Z80.FLAG_N, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_CP_C_More() {
    ...
    assertEquals(0xF7, cpu.getRegister(Z80.REG_A));
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_N | Z80.FLAG_C | Z80.FLAG_S | Z80.FLAG_H, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_CP_C_Less() {
    ...
    assertEquals(0xF7, cpu.getRegister(Z80.REG_A));
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_N, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_ADD_HL_DE() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_Z | Z80.FLAG_S | Z80.FLAG_PV | Z80.FLAG_H, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_ADD_IX_DE() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_Z | Z80.FLAG_S | Z80.FLAG_PV, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_NEG() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_C | Z80.FLAG_N | Z80.FLAG_H, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_CCF_Set() {
    ...
    assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_H | Z80.FLAG_PV | Z80.FLAG_Z | Z80.FLAG_S, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_INC_A() {
    ...
    assertEquals(0x29, cpu.getRegister(Z80.REG_A));
    assertEquals(Z80.FLAG_C | Z80.FLAG_X1 | Z80.FLAG_X2, cpu.getRegister(Z80.REG_F) & 0xFF);
  ...
  public void testCommand_DEC_D() {
    ...
    assertEquals(Z80.FLAG_C | Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_N, cpu.getRegister(Z80.REG_F) & 0xFF);
    assertTacts(cpu, 4);
  }
  ...
  public void testCommand_RLA() {
    ...
    assertEquals(0, cpu.getRegister(Z80.REG_F));
    assertTacts(cpu, 4);
  }
  ...
  public void testCommand_RRC_D() {
    ...
    assertEquals(Z80.FLAG_C | Z80.FLAG_S, cpu.getRegister(Z80.REG_F));
    assertTacts(cpu, 8);
  }
  ...
  public void testCommand_BIT_2_reg() {
    ...
    for (int i = 0; i < codes.length; i++) {
      ...
      assertEquals(Z80.FLAG_Z | Z80.FLAG_H, cpu.getRegister(Z80.REG_F));
      assertTacts(cpu, 8);
    }
  }
  ...
  @Test
  public void testCommand_RET_4_mIXd() {
    final Z80State state = new Z80State();
    state.IX = 0x5000;
    state.F = 0xFF;
  ...
  @Test
  public void testCommand_RET_4_mIYd() {
    final Z80State state = new Z80State();
    state.IY = 0x5000;
    state.F = 0xFF;
  ...
  public void testCommand_HALT() {
    final Z80 cpu = new Z80(new TestBus(0, 0, 0x76));

    assertEquals(0xFFFFFFFF, cpu.getState());

    cpu.nextInstruction(false, false, false);

    assertEquals(~Z80.SIGNAL_OUT_nHALT, cpu.getState());
  ...
  public void testCommand_CALL_nn() {
    ...
    assertEquals(0x1A, testbus.readMemory(cpu, 0x3001, false));
    assertEquals(0x4A, testbus.readMemory(cpu, 0x3000, false));
  ...
  public void testCommand_RET() {
    ...
    testbus.writeMemory(cpu, 0x2000, (byte) 0xB5);
    testbus.writeMemory(cpu, 0x2001, (byte) 0x18);
  ...
  public void testCommand_RETN() {
    final TestBus testbus = new TestBus(0, 0x3535, 0xED, 0x45);
    final Z80 cpu = new Z80(testbus);
  ...
  public void testCommand_RST_nn() {
    ...
    for (int i = 0; i < codes.length; i++) {
      ...
      assertEquals(0x1A, testbus.readMemory(cpu, 0x3001, false));
      assertEquals(0x48, testbus.readMemory(cpu, 0x3000, false));
      assertEquals(0x3000, cpu.getRegister(Z80.REG_SP));
  ...
  public void testCommand_IN_A_n() {
    ...
    tb.writePort(null, 0x2301 , (byte)0x7B);
  ...
  public void testCommand_IN_r_mC() {
    ...
    for (int i = 0; i < codes.length; i++) {
      ...
      tb.writePort(null, 0x1007, (byte) 0x7B);
      ...
      assertEquals(Z80.FLAG_X1 | Z80.FLAG_X2 | Z80.FLAG_C | Z80.FLAG_PV, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommand_INI() {
    ...
    assertEquals(0x7B, tb.readMemory(cpu, 0x1000, false) & 0xFF);
    assertEquals(0x1001, cpu.getRegisterPair(Z80.REGPAIR_HL));
    assertEquals(0x0F, cpu.getRegister(Z80.REG_B));
    assertEquals(Z80.FLAG_N, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommandINIR() {
    ...
    tb.writePort(null, 0x0307, (byte)0x51);
    tb.writePort(null, 0x0207, (byte)0xA9);
    tb.writePort(null, 0x0107, (byte)0x03);
    ...
    assertEquals(0x51, tb.readMemory(cpu, 0x1000, false) & 0xFF);
    assertEquals(0xA9, tb.readMemory(cpu, 0x1001, false) & 0xFF);
    assertEquals(0x03, tb.readMemory(cpu, 0x1002, false) & 0xFF);
    
    assertEquals(0x1003, cpu.getRegisterPair(Z80.REGPAIR_HL));
    assertEquals(0x0007, cpu.getRegisterPair(Z80.REGPAIR_BC));
    assertEquals(Z80.FLAG_Z | Z80.FLAG_N, cpu.getRegister(Z80.REG_F));
  ...
  public void testCommand_INDR() {
    ...
    assertEquals(0x51, tb.readMemory(cpu, 0x1000, false) & 0xFF);
    assertEquals(0xA9, tb.readMemory(cpu, 0x0FFF, false) & 0xFF);
    assertEquals(0x03, tb.readMemory(cpu, 0x0FFE, false) & 0xFF);
  ...
  public void testCommand_OUT_mn_A(){
    ...
    assertEquals(0x23, tb.readPort(cpu, 0x2301));
  ...
  public void testCommand_OUT_mC_r(){
    ...
    for (int i = 0; i < codes.length; i++) {
      ...
      assertEquals("index " + i, 0x15, tb.readPort(cpu, 0x1007) & 0xFF);
  ...
  public void testCommand_OUT_mC_0(){
      ...
      final Z80 cpu = new Z80(tb);
      tb.writePort(cpu, 0x1007, (byte) 0x67);
      cpu.setRegister(Z80.REG_PC, 0);
      cpu.setRegister(Z80.REG_C, 0x07);
      cpu.setRegister(Z80.REG_B, 0x10);
      cpu.setRegister(Z80.REG_F, 0x88);
      ...
      assertEquals(0x0002, cpu.getRegister(Z80.REG_PC));
      assertEquals(0x00, tb.readPort(cpu, 0x1007) & 0xFF);
  ...
  public void testCommand_OUTI() {
    ...
    cpu.setRegister(Z80.REG_L, 0x00);
    cpu.setRegister(Z80.REG_F, 0x00);
    tb.writeMemory(cpu, 0x1000, (byte)0x59);
    
    cpu.nextInstruction(false, false, false);

    assertEquals(0x02, cpu.getRegister(Z80.REG_PC));
    assertEquals(0x59, tb.readPort(cpu, 0x1007) & 0xFF);
    assertEquals(0x0F, cpu.getRegister(Z80.REG_B));
  ...
  public void testCommand_OUTIR() {
    ...
    tb.writeMemory(null, 0x1000, (byte) 0x51);
    tb.writeMemory(null, 0x1001, (byte) 0xA9);
    tb.writeMemory(null, 0x1002, (byte) 0x03);
    ...
    assertEquals(0x51, tb.readPort(cpu, 0x0307) & 0xFF);
    assertEquals(0xA9, tb.readPort(cpu, 0x0207) & 0xFF);
    assertEquals(0x03, tb.readPort(cpu, 0x0107) & 0xFF);
  ...
  public void testCommand_OUTDR() {
    ...
    tb.writeMemory(null, 0x1000, (byte) 0x51);
    tb.writeMemory(null, 0x0FFF, (byte) 0xA9);
    tb.writeMemory(null, 0x0FFE, (byte) 0x03);
